...
- 🔒 **CVE-2025-46569安全修复**: 添加安全通告文档，修复高危漏洞
- 🔒 **版本兼容性矩阵更新**: 推荐OPA v1.4.0+，移除已弃用版本
- 🔒 **安全加固检查项**: 新增生产环境安全检查清单

### 新增 (Added)

- ✨ **OPA v1.4+兼容性支持**: 完整适配OPA最新版本特性
- ✨ **Rego v1.0语法规范**: 支持强制if/contains新语法

### 改进 (Changed)

- ⬆️ **版本对齐**: 对齐OPA v1.4.0最新版本
- ⬆️ **语法规范对齐**: 对齐Rego v1.0正式语法规范
- 🔧 **推荐版本更新**: 更新所有文档中的推荐版本引用
- 📝 **Rego语法规范文档**: 更新为OPA v1.0+强制if/contains语法
- 📝 **安全合规标准**: 更新至最新行业标准
- 📝 **性能优化指南**: 针对OPA v1.4+进行优化建议更新
...
| **v2.6** | **2026-03-19** | **OPA v1.4+兼容 + 安全修复** |
