...
| # | 文档名称 | 字数 | 覆盖内容 | 状态 |
|---|---------|------|---------|------|
| 0 | 总览与索引 | ~8K | 完整导航、形式化框架、学习路径 | ✅ |
| 1 | API规范 | ~7K | REST/gRPC、认证、性能 | ✅ |
| 2 | Rego语法规范 | ~9K | 语法、数据类型、运算符 | ✅ |
| 3 | 词法分析与语法解析 | ~6K | Lexer、Parser、AST | ✅ |
| 4 | Top-Down求值器 | ~8K | 求值算法、统一、优化 | ✅ |
| 5 | Kubernetes集成 | ~8K | Admission Webhook、Gatekeeper | ✅ |
| 6 | 访问控制(RBAC) | ~9K | RBAC模型、策略实现、高级模式 | ✅ |
| 7 | Rego形式化语义 | ~9K | 语法域、操作语义、正确性定理 | ✅ |
| 8 | 核心概念定义 | ~8K | 5层概念、关系网络、概念矩阵 | ✅ |
| 9 | 策略设计模式 | ~8K | SOLID、结构模式、反模式 | ✅ |
